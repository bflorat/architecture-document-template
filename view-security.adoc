...
//🏷{"id": "a08e807e-1e9b-4752-a5b8-372a40665c49", "labels": ["level::basic", "project_size::medium", "detail_level::overview", "context"]}
## Introduction
...
//🏷{"id": "cd8c64f1-d216-4b24-946c-175455e824a7", "labels": ["level::basic", "project_size::medium", "detail_level::overview", "context"]}
...
//🏷{"id": "ea245600-dbd6-4f56-a58c-8c77556643ad", "labels": ["level::basic", "project_size::medium", "detail_level::overview", "open-questions"]}
## Not ruled

//🏷{"id": "a058d388-72e1-4136-8659-7a9db1c1a340", "labels": ["level::basic", "project_size::medium", "detail_level::abstract", "open-questions"]}
...
//🏷{"id": "68a4f41c-1139-4cdd-bb9e-e15667f47fd9", "labels": ["level::basic", "project_size::medium", "detail_level::overview"]}
### Assumptions
.Assumptions
[cols="e,e"]
|====
...
//🏷{"id": "53ae9c06-1846-4dd2-ab55-f4a784c6a676", "labels": ["level::intermediate", "project_size::medium", "detail_level::detailed", "constraint"]}
## Constraints
[TIP]
====
...
//🏷{"id": "4882e5b9-c250-4079-8b24-04996016606d", "labels": ["level::intermediate", "project_size::medium", "detail_level::detailed", "requirement"]}
## Requirements
[TIP]
====
...
//🏷{"id": "323d4c77-810a-4015-bc1a-11da07e24f3b", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "requirement", "solution"]}
### Integrity requirements
[TIP]
====
...
//🏷{"id": "acfa846e-0ed7-4f41-a593-f4ee29e94efd", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "requirement", "solution"]}
### Confidentiality requirements
[TIP]
====
[quote]
...
//🏷{"id": "94c138c1-3e8b-4eaf-8926-b5b9bfa6a86b", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "requirement", "solution"]}
### Identification requirements
[TIP]
====
...
//🏷{"id": "9d0646cd-3e3f-4878-96de-f215c9f20bdc", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "requirement", "solution"]}
### Authentication requirements
[TIP]
====
...
//🏷{"id": "f552f1e6-9aea-4866-8da1-e7ed676fd228", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "requirement", "solution"]}
### Identity Federation Requirements
[TIP]
====
...
[[sso-requirements]]
//🏷{"id": "400376ad-cc62-4ab3-8e96-5a9f9a954e49", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "requirement", "solution"]}
...
//🏷{"id": "01404b83-f96f-4649-ace0-e5611601b830", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "requirement", "solution"]}
### Non-repudiation requirements
[TIP]
====
...
//🏷{"id": "958fcccc-60cb-4158-940f-279cd1d12c9b", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "requirement", "solution"]}
...
//🏷{"id": "fcad5990-c241-4c88-b2c5-646602f8935a", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "requirement", "solution"]}
...
//🏷{"id": "e72e5ea5-5711-4665-8a91-76c63cbca2bc", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "requirement", "solution"]}
...
//🏷{"id": "d1f16239-18f7-4a4a-875e-34a587eb88b4", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "solution"]}
## Security measures

//🏷{"id": "e60500e8-b4a3-471c-941c-8fd8c02c4da9", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth", "solution"]}
### Integrity
...
| Business database data | No alteration | a|
...
//🏷{"id": "a64b5e5d-e4d4-4ed2-b425-19cd542fa58e", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth", "solution"]}
### Confidentiality
Measures meeting the <>:
...
//🏷{"id": "3779a946-fc73-455b-8bab-3d5398ce0311", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth", "solution"]}
### Identification
Measures meeting the <> :
...
//🏷{"id": "ac587042-7060-44cf-96aa-93fddadc15f5", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth", "solution"]}
### Authentication
Measures meeting the <>:
[TIP]
====
...
//🏷{"id": "49de0015-9e27-4f60-91ca-282feec8345d", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth", "solution"]}
### Identity federation
Measures meeting the <>:
[TIP]
====
...
//🏷{"id": "1c4774ab-e6fc-46a4-bb89-97e318a8dd8f", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth", "solution"]}
### SSO, SLO
Measures meeting the <>:
[TIP]
====
...
//🏷{"id": "8e35ee35-b5bc-433b-8389-f07e62a05339", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth", "solution"]}
### Service accounts
[TIP]
====
...
//🏷{"id": "9f09dacf-d151-45af-a5f6-209823e7a401", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth", "solution"]}
...
//🏷{"id": "72efb92f-13f8-48e5-aed1-b57c4eab56fc", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth", "solution"]}
...
//🏷{"id": "e6d0ad26-40b7-412e-b861-1f8e6e2299ca", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth", "solution"]}
### Authorizations
Measures meeting the <>:
====
...
//🏷{"id": "3819b8cc-d9c4-4d29-9ca1-adae300a79e2", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth", "solution"]}
...
//🏷{"id": "5e00eeef-1d5b-4a21-ac19-116ae376d999", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "solution"]}
...
//🏷{"id": "d13f2885-ab5c-4543-9432-f53002c01c2c", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "solution"]}
...
//🏷{"id": "ac7dde83-27c9-4916-9020-73efaab5fcb1", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "solution"]}
#### Detection Solutions
Include:
...
//🏷{"id": "d4498522-32aa-4987-aaec-2d9cf01130da", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "solution"]}
...
//🏷{"id": "a69b42f5-4f4e-42bf-b4bc-c6093941600f", "labels": ["level::advanced", "project_size::medium", "detail_level::in-depth", "solution"]}
...
//🏷{"id": "1b185643-82bd-4376-959e-02a24690928c", "labels": ["level::intermediate", "project_size::medium", "detail_level::detailed", "context"]}
## RACI
[NOTE]
====
...
//🏷{"id": "8b5945b8-14f2-45ae-9965-49397d3f94d2", "labels": ["level::basic", "project_size::medium", "detail_level::abstract"]}
...
//🏷{"id": "5c93aa54-4321-405d-9a1d-dc81cda55a80", "labels": ["level::basic", "project_size::medium", "detail_level::abstract"]}
...
//🏷{"id": "b2f76b28-83da-478b-bc94-f1bc29dc6084", "labels": ["level::intermediate", "project_size::medium", "detail_level::detailed", "context"]}
## RACI
[NOTE]
====
...
//🏷{"id": "a92779ad-62bb-413e-b9ff-ac16c4552c5c", "labels": ["level::basic", "project_size::medium", "detail_level::abstract"]}
...
//🏷{"id": "18fcc330-56e5-46d6-ad41-769bd7be3e3c", "labels": ["level::basic", "project_size::medium", "detail_level::abstract"]}
...
//🏷{"id": "7d8dff71-3acd-450b-bc68-d2e2efee2fbb", "labels": ["level::intermediate", "project_size::medium", "detail_level::detailed"]}
## Self-checks

//🏷{"id": "68556bb6-b10d-4fe3-b956-ae9c5f926f4a", "labels": ["level::intermediate", "project_size::medium", "detail_level::detailed"]}
