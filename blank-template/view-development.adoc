...
### Concurrency
TIP: See also xref:view-application.adoc#9efde825-9508-4669-918c-7cfb0d45c21f[Concurrency management Requirements].
...
### Log management
TIP: See also xref:view-infrastructure.adoc#0a25770c-6a02-4fa3-82cc-bf5152d3cba6[Log Constraints].
...
TIP: See also <<fbe627e5-be3f-41ec-9a2a-c43bd3587c6e,Internationalization (i18n) Requirements>>.
