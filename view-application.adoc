...
//🏷{"id": "74c82505-5f47-4342-8f1b-f6951d603062", "labels": ["level::*", "project_size::*", "detail_level::*","context"]}
## Introduction
...
//🏷{"id": "c182158d-40af-4840-b8f2-3a2a030c95af", "labels": ["context"]}
...
//🏷{"id": "60a52e4c-4416-429a-a739-37153b05133c", "labels": ["level::basic", "project_size::*", "detail_level::detailed", "context", "open-questions"]}
### Assumptions
...
//🏷{"id": "ba1f44fe-c47a-4d34-bfdb-07e777e23dda", "labels": ["level::basic", "project_size::*", "detail_level::overview", "context"]}
### Objectives
...
//🏷{"id": "bbb1f617-3ceb-4f80-a3c4-dbc9b16bcd00", "labels": ["level::basic", "project_size::*", "detail_level::overview", "context"]}
### Existing
...
//🏷{"id": "d979e090-c43f-48f5-a0e3-83b810efff9f", "labels": ["level::basic", "project_size::*", "detail_level::overview", "constraint"]}
## Constraints

//🏷{"id": "58897e87-0c12-4139-b5da-daec9cae21c6", "labels": ["level::basic", "project_size::*", "detail_level::overview", "constraint"]}
### Budget
...
//🏷{"id": "ac5b1f28-bfcb-4543-a90b-abcff2b41822", "labels": ["level::basic", "project_size::*", "detail_level::overview", "constraint"]}
### Planning
...
//🏷{"id": "5837249a-8fcc-4e42-9dd9-384c4fa32afc", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}
### Urbanization
...
//🏷{"id": "abafa462-262f-429e-aad8-d2cdc0cf15a3", "labels": ["level::intermediate", "project_size::medium", "detail_level::detailed", "constraint"]}
### Legals
...
//🏷{"id": "3b714287-891e-4ea3-a7a4-17672caaf945", "labels": ["level::basic", "project_size::*", "detail_level::overview", "constraint"]}
## Requirements
...
//🏷{"id": "9352a89a-3f8b-4028-98d5-58fb970e01ef", "labels": ["level::basic", "project_size::large", "detail_level::overview", "constraint"]}
...
//🏷{"id": "38fd6aa0-2354-4d0d-9812-10ed917eae5e", "labels": ["level::basic", "project_size::large", "detail_level::overview", "constraint"]}
### Interoperability
...
//🏷{"id": "ec7cfacf-e267-4937-80e8-b5c92409ecd1", "labels": ["level::basic", "project_size::medium", "detail_level::detailed", "constraint"]}
### Archiving
...
//🏷{"id": "b269e65b-a8c7-4518-a861-5c6c17802869", "labels": ["level::basic", "project_size::*", "detail_level::overview", "solution"]}
## Target architecture

//🏷{"id": "2c107a25-a1c4-433d-b746-e12aa2c6eea1", "labels": ["level::basic", "project_size::*", "detail_level::overview", "solution"]}
...
//🏷{"id": "6390e724-c2f0-4737-99a0-531fdcfe8e20", "labels": ["level::basic", "project_size::medium", "detail_level::detailed", "solution"],"link_to":["1525a303-3c07-4d5c-8e9c-26f3e3a0e01c"]}
...
//🏷{"id": "148fd29c-b0a0-4bff-b5da-71f5b1195e1e", "labels": ["level::intermediate", "project_size::medium", "detail_level::detailed"]}
...
//🏷{"id": "d4124d8e-47b9-4cfa-94ec-8164180bdecc", "labels": ["level::medium", "project_size::large", "detail_level::detailed"]}
#### Inventory view
...
//🏷{"id": "6c06792f-9e6d-4156-88d3-468063716834", "labels": ["level::medium", "project_size::large", "detail_level::detailed"]}
#### Dynamic view
...
//🏷{"id": "f49dc567-ef07-45db-b25a-34c57a58f213", "labels": ["level::medium", "project_size::*", "detail_level::overview"]}
### Archiving
...
//🏷{"id": "7a01e2dd-1921-4e41-95d6-57f2b80e447b", "labels": ["level::intermediate", "project_size::medium", "detail_level::detailed"]}
### Purges
...
//🏷{"id": "3a80c49f-5f9d-4c1d-bcb5-d3ef292e2895", "labels": ["level::basic", "project_size::medium", "detail_level::in-depth"]}
