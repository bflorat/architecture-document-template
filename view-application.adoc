...
//🏷{"id": "c182158d-40af-4840-b8f2-3a2a030c95af", "labels": ["level::*", "project_size::*", "detail_level::*","context"]}
...
//🏷{"id": "946b3119-a878-47ca-86f2-4c9e22ef0c89", "labels": ["level::*", "project_size::medium", "detail_level::detailed","context", "open-questions","context"]}
## Not ruled

//🏷{"id": "af23d422-402c-49be-900f-2f55a5619615", "labels": ["level::intermediate", "project_size::medium", "detail_level::detailed", "open-questions","context"]}
...
//🏷{"id": "f1f481b6-e006-49e5-afbb-40ce4652eadf", "labels": ["level::intermediate","level::medium","project_size::medium", "detail_level::*","context","open-questions"]}
### Assumptions
...
//🏷{"id": "ed5f86f2-2ec3-47c0-bb77-2608bdad690a", "labels": ["level::*", "project_size::*", "detail_level::basic", "context"]}
### Objectives
...
//🏷{"id": "34104769-837d-4417-b7ac-06cd74b16d62", "labels": ["level::basic", "project_size::medium", "detail_level::overview", "context"]}
### Existing
...
//🏷{"id": "67bbae56-5ed3-4977-8467-2c951882d1a9", "labels": ["level::basic", "project_size::medium", "detail_level::overview"]}
### Positioning in the IS

[TIP]
If the IS is urbanized, identify the block concerned by the project.

//🏷{"id": "9ca40d05-ab6e-42ab-aa3c-b9724373ae7f", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "context"]}
### Actors

//🏷{"id": "f5da02a5-2942-4c3c-98b3-7af866ea8bf9", "labels": ["level::basic", "project_size::medium", "detail_level::overview", "context"]}
#### Internal actors
...
//🏷{"id": "f7ef9f4a-f9d1-4c55-9f85-1d9d48722ce6", "labels": ["level::basic", "project_size::medium", "detail_level::overview", "context"]}
#### External actors
