...
The available measures are very varied and should be chosen by the architect according to their contribution and their cost (financial, complexity, etc.).

We group availability measures into four main categories:

* Supervisory measures allowing faults to be detected as early as possible, hence lowering the MTDT (average detection time).
