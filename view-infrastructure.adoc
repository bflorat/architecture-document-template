...
//🏷{"id": "e3208a9c-8d35-46a1-9399-aacea9817e0a", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}## Introduction
...
//🏷{"id": "06fd3383-f875-4a44-a1f8-d135f9050038", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Reference Documentation
[TIP]
...
//🏷{"id": "933039be-008f-40c7-a630-a08002b379f1", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}## Not ruled
//🏷{"id": "87385297-c5c3-44f6-b9e8-7599576dda0a", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Points subject to further study
...
//🏷{"id": "30d20b83-e35d-464b-8286-3ff230fb1471", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Assumptions
...
//🏷{"id": "82a207de-bc6f-4a62-a586-96a2b4c9f4dc", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}## Constraints
...
//🏷{"id": "cc4a17a8-d68b-43cf-8b4e-c64829d950fc", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Constraints on availability
...
//🏷{"id": "a18eb613-e522-4bf5-a1fd-742b9d754ce1", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### MTTD
...
//🏷{"id": "dc11b031-5685-4972-9832-138fa74cd30b", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Monitoring tools
...
//🏷{"id": "6903a99e-8b8e-464b-909c-d40da5a808d1", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### MTTR
...
//🏷{"id": "421860fb-b6b3-461a-b149-57c6ba6dae41", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Scheduled interruptions
...
//🏷{"id": "21d704f6-f740-40f9-986c-36274643a711", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Level of service of the datacenter
...
//🏷{"id": "7c1d0446-34df-4572-92b0-19baaba54183", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Summary of floor availability
...
//🏷{"id": "4860fb1c-98e9-4c2c-adfc-09ea8149235d", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Disaster management (DRP/BCP)
...
//🏷{"id": "c7c4fce5-c971-4ec8-bef7-006381492aff", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Hosting
...
//🏷{"id": "6f7d74be-7024-4a6e-af4d-d084d49109ae", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Network constraints
...
//🏷{"id": "86a3082e-7069-4120-b86f-f886ef919986", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Deployment constraints
...
//🏷{"id": "0a25770c-6a02-4fa3-82cc-bf5152d3cba6", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Log constraints
...
//🏷{"id": "608d63e6-7299-4976-bf59-52fa1c6ac486", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Backup and restore constraints
...
//🏷{"id": "22e6cfa3-bc3d-466c-a902-9854540258b7", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Costs
...
//🏷{"id": "f9ed2469-e3e5-48a1-8b69-4b9c9492c6cb", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}## Requirements
...
//🏷{"id": "332c967b-3729-4a5f-984e-fc2f301b0329", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Operating ranges
...
//🏷{"id": "08cb1019-20c4-42ef-9bf2-4adf72936c1c", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Availability requirements
...
//🏷{"id": "afdd573d-d1f8-4958-99c1-e404592396d0", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Degraded modes
[TIP]
====
...
//🏷{"id": "231768e7-6a9d-429e-b200-2febdd91a0e3", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Robustness requirements
...
//🏷{"id": "f0e94586-876d-46ca-b060-b5dcde468734", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### RPO requirements
...
//🏷{"id": "3e07d851-b2dc-422f-9cba-1b4447a5c956", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### RTO Requirements
...
//🏷{"id": "cdb68f23-d2c5-4373-9f7d-e358191f0ebf", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Deployment and update requirements

//🏷{"id": "663ee84f-7dde-4c6d-acf6-a810ab8fafb4", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Server side
...
//🏷{"id": "fd64ad27-05da-42f0-9491-f790642b5d91", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Client side
...
//🏷{"id": "0bbb4d10-bb6c-4cb0-b227-2e97db99eae1", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Specific deployment strategy
...
//🏷{"id": "7d3090d0-87d0-434f-9717-f9a12ccf60d1", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Concurrency management requirements
...
//🏷{"id": "da0d11fe-0dc9-478e-a984-7a80ea1be482", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Ecodesign requirements
...
//🏷{"id": "602a7a0a-7f25-4512-b0ab-3b97c8a734e0", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}## Target architecture

//🏷{"id": "8088138c-5258-4f3a-a293-0984501bb5db", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Principles
...
//🏷{"id": "17a46000-c51d-4fb7-868c-7386aef5b523", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Availability
...
//🏷{"id": "c23ff676-32e3-4957-8cec-6a7619a33567", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Deployment in production
...
//🏷{"id": "28ba010e-1c33-41b9-8061-9596710563bc", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Versions of infrastructure components
...
//🏷{"id": "3ff53ea7-2e7f-4d71-8848-6819ba23c930", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Matrix of network flows
...
//🏷{"id": "93947744-e0ec-4bc3-af30-cc60473b7caf", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Environments
...
//🏷{"id": "0bbc320c-6291-4a89-b263-66abf1906ab0", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Ecodesign
...
//🏷{"id": "46e9c057-75cb-4bc0-9c8d-9af81f737c61", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Load regulation

//🏷{"id": "32466600-a3a5-465f-9679-2a244b34321e", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Circuit breakers
...
//🏷{"id": "44f0732c-3b29-4bd5-873f-046fc010f728", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Quality of Service
...
//🏷{"id": "5fa5ed39-9b6d-4dec-a8c1-1dc1929ff796", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Timeout management
...
//🏷{"id": "c9a330f1-ffde-44e2-a432-a1e178440333", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Operations
...
//🏷{"id": "0a3f0e4e-0458-4528-9513-1f75a4ad8464", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Stop/start-up sequence
...
//🏷{"id": "314a1ef0-48b4-42a4-a8b6-be49250c5a50", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Scheduled operations
...
//🏷{"id": "0cf18e71-b20e-4b2b-9377-e104c21c9785", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Switch to maintenance mode procedure
...
//🏷{"id": "fd5b00b0-4b23-4cbc-8117-0dcee74ddd8b", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Backups and restores
...
//🏷{"id": "74ff1a8d-91b4-4437-bbfd-439e3d4b18b5", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Logs
...
//🏷{"id": "f31e9b70-8bf9-41b5-bbb0-c6b3f6de9347", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}#### Monitoring
...
//🏷{"id": "56cf150f-625e-48e0-9600-327b4d5e3508", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Jobs scheduling
...
//🏷{"id": "9ac6e5d2-e9a0-427e-ba12-27dedbd8ac4d", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Migrations
...
//🏷{"id": "53b2f98c-11d9-4aa0-b762-b8f31db0c30f", "labels": ["level::intermediate", "project_size::large", "detail_level::overview", "constraint"]}### Decommissioning
