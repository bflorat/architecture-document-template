...
The indicators are logical combinations of several metrics with thresholds (e.g. critical level if the CPU usage on server s1 remains above 95% for more than 5 minutes).
====
